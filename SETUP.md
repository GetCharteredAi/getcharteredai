...
JWT_SECRET = (any long random string, e.g. paste this: gca-jwt-secret-2025-apc-platform-secure-key-x9k2m)
...
6. Copy the "Signing secret" (starts with whsec\_)
...
1. In Netlify env vars, change STRIPE*SECRET_KEY to your sk_live*... key
2. In index.html, change the STRIPE*KEY variable to your pk_live*... key
