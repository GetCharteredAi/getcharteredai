// netlify/functions/apprentice-report-status.js
// Polling endpoint for Apprentice review report generation status.
// Called every 8s by the frontend after submitting to apprentice-generate-report-background.
...
exports.handler = async (event) => {
  ...
  try {
    ...
    console.error('[apprentice-report-status] Error:', err.message);
